...
class TranslationTrainer:
    ...
    def domain_adapt(self, output_dir: str) -> None:
        ...
        try:
            ...
            logging.info(f"Model domain-adapted and saved to {output_dir}")
        except FileNotFoundError as e:
            raise TranslationTrainingError(f"Output directory not found: {e}")
        except PermissionError as e:
            raise TranslationTrainingError(f"Permission denied: {e}")
